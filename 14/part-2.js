...
;
	...
	// add line for floor at y = maxy + 2 wide enough to contain an isosceles
	// triangle having vertex where sand exits
...
const drawMap = () => {
	...
	for (let y = ymin; y <= ymax; y++) {
		...
		console.log(numberPad(y, 3), row.join(''));
	}
};
